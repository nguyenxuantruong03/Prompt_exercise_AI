      ...
      <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
        {Object.entries(levelEquivalencies).map(([level, info]) => (
          <Button
            ...
            className={`p-5 border rounded-lg text-center transition-all hover:shadow-md whitespace-normal h-full ${
              proficiencyLevel === level
                ? "bg-blue-600 text-white hover:text-black dark:hover:text-white border-blue-600 hover:bg-blue-700"
                : "bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600  dark:hover:bg-gray-600 "
            }`}
          >
