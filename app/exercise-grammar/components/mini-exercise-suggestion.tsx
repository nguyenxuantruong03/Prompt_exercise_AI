        ...
        <div className="p-6">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-orange-700 dark:text-orange-300 text-sm">
                  You've made several mistakes in this area recently. A quick
                  mini practice session can help you master this grammar point
          ...
          <div className="mt-4 p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border border-purple-200 dark:border-purple-800 rounded-lg">
            <p className="text-sm text-purple-700 dark:text-purple-300 text-center">
              ...
              these rules! Each mistake is a step closer to mastery. You've got
              this! 💪
            </p>
          </div>
        </div>
