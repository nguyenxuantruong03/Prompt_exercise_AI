const PassiveVoiceData = {
    ...
    A1: {
      ...
      basicPresentPassive: {
        ...
        exercises: [
          "Complete: The book ___ (is written) by John.",
          "Complete: Coffee ___ (is grown) in Brazil.",
          "Complete: English ___ (is spoken) here.",
        ],
      },
      basicPastPassive: {
      ...
      exercises: [
        "Complete: The house ___ (was built) in 1990.",
        "Complete: The letter ___ (was sent) yesterday.",
        "Complete: The car ___ (was repaired) last week.",
      ],
    },
    ...
    A2: {
      ...
      exercises: [
        "Complete: The meeting ___ (will be held) tomorrow.",
        "Complete: The work ___ (has been completed).",
        "Complete: The book ___ (was written) by Shakespeare.",
      ],
    },
    ...
    B1: {
      ...
      exercises: [
        "Complete: The house ___ (is being painted).",
        "Complete: The road ___ (is being repaired).",
        "Complete: I ___ (was given) a book.",
      ],
    },
    ...
    B2: {
      ...
      exercises: [
        "Complete: The documents ___ (have been sent).",
        "Complete: The work ___ (had been finished) before noon.",
        "Complete: It ___ (is believed) that the Earth is round.",
      ],
    },
    ...
    C1: {
      ...
      exercises: [
        "Complete: The research ___ (was conducted) by a team of experts.",
        "Complete: The data ___ (was analyzed) using statistical methods.",
        "Complete: The house ___ (needs to be painted).",
      ],
    },
    ...
    C2: {
      ...
      exercises: [
        "Complete: The city ___ (was destroyed) by the earthquake.",
        "Complete: The truth ___ (was finally revealed).",
        "Complete: The defendant ___ (was found guilty) by the jury.",
      ],
    },
    ...
    // Passive Voice Exercises and Practice Activities
    passiveVoiceExercises: {
      concept: "Comprehensive exercises for practicing passive voice",
      basicExercises: {
        type: "Simple passive completion",
        exercises: [
          "The book ___ (is written) by John.",
          "The house ___ (was built) in 1990.",
          "Coffee ___ (is grown) in Brazil.",
          "The letter ___ (was sent) yesterday.",
        ],
      },
      intermediateExercises: {
        type: "Complex passive usage",
        exercises: [
          "The house ___ (is being painted).",
          "The work ___ (has been completed).",
          "The meeting ___ (will be held) tomorrow.",
          "The book ___ (was written) by Shakespeare.",
        ],
      },
      advancedExercises: {
        type: "Advanced passive patterns",
        exercises: [
          "The research ___ (was conducted) by experts.",
          "It ___ (is believed) that the Earth is round.",
          "The problem ___ (was dealt with) by the committee.",
          "The defendant ___ (was found guilty) by the jury.",
        ],
      },
      errorCorrection: {
        type: "Identify and correct passive errors",
        exercises: [
          "The house was painting. → ___",
          "The letter was write. → ___",
          "The room is cleaned now. → ___",
          "The work needs to be do. → ___",
        ],
      },
    },
